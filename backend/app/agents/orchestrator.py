...
class MultiAgentOrchestrator:
    ...
    def _prepare_agent_input(self, node_data: Dict[str, Any], state: WorkflowState) -> Dict[str, Any]:
    ...
    async def _execute_http_request(self, node_data: Dict[str, Any], state: WorkflowState) -> Dict[str, Any]:
    ...
    def _evaluate_condition(self, node_data: Dict[str, Any], state: WorkflowState) -> Dict[str, Any]:
    ...
    async def _execute_database_operation(self, node_data: Dict[str, Any], state: WorkflowState) -> Dict[str, Any]:
    ...
    async def execute_workflow(self, workflow_data: Dict[str, Any], input_data: Dict[str, Any] = None) -> Dict[str, Any]:
