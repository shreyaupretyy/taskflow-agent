...
class VectorDBService:
    ...
    def __init__(self):
        self.client = chromadb.Client(
            Settings(persist_directory=settings.CHROMA_PERSIST_DIR, anonymized_telemetry=False)
        )
    ...
    def add_documents(
        ...
        return {"success": True, "collection": collection_name, "count": len(documents), "ids": ids}
    ...
    def update_document(
        ...
        return {"success": True, "id": document_id, "updated": True}
    ...
    def delete_collection(self, collection_name: str) -> Dict[str, Any]:
        ...
        return {"success": True, "collection": collection_name, "deleted": True}
