...
workflow_executions_total = Counter(
    "workflow_executions_total", "Total number of workflow executions", ["status"]
)
...
active_workflows = Gauge("active_workflows", "Number of currently active workflows")

node_executions_total = Counter(
    "node_executions_total", "Total number of node executions", ["node_type", "status"]
)
